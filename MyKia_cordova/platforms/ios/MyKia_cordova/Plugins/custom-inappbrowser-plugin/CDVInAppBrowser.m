...
- (void)createViews
{
    ...
    webViewBounds.size.height -= 61;
    webViewBounds.origin.y = 61;
...
/*
    self.spinner = [[UIActivityIndicatorView alloc] initWithActivityIndicatorStyle:UIActivityIndicatorViewStyleGray]; // UIActivityIndicatorViewStyleWhiteLarge
    ...
    self.spinner.frame = CGRectMake(CGRectGetMinX(self.webView.frame) + 17, CGRectGetMaxY(self.webView.frame) + 17, 10.0, 10.0);
...
- (void) rePositionViews {
    if ([_browserOptions.toolbarposition isEqualToString:kInAppBrowserToolbarBarPositionTop]) {
        [self.webView setFrame:CGRectMake(self.webView.frame.origin.x, 61, self.webView.frame.size.width, self.webView.frame.size.height)];
        [self.toolbar setFrame:CGRectMake(self.toolbar.frame.origin.x, 61, self.toolbar.frame.size.width, self.toolbar.frame.size.height)];
    }
}
...
- (void) viewDidLoad {
    ...
    bgToolbar.barStyle = UIBarStyleDefault; // MGALVIN
    // bgToolbar.tintColor = [UIColor whiteColor];
    // bgToolbar.view.backgroundColor = [UIColor whiteColor];
